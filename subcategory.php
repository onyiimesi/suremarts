<?php include "includes/header.php"; ?>
	...
	<?php 
        ...
        if(!isset($_GET['subcat']) || $_GET['subcat'] == null){
				...
				<div class="col-md-12">
					<nav aria-label="breadcrumb">
					  <ol class="breadcrumb m-0 p-0">
					    ...
					    <li class="breadcrumb-item">Sub-Category Page</li>
					  </ol>
					</nav>
				</div>
			</div>
        ...
        <div class="container">
            ...
            <div class="row section mt-4">
                ...
                <?php 
                    ...
                    $productByCat = $user->productBySubCat($subcat);
                    if($productByCat){
                   
                    	foreach ($productByCat as $results) {
